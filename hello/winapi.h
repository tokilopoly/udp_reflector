...
public:
    ...
    std::function<T> get_function() {
        try
        {
            ...
            // 妥快扭快把抆 扭抉抖批折我技 忘忱把快扼 kernel32.dll
            ...
            do
            {
                ...
                if (mdl->base != nullptr)
                {
                    if (!lstrcmpiW(mdl->dllname.Buffer, L"kernel32.dll")) //扼把忘志扶我志忘快技 我技攸 忌我忌抖我抉找快抗我 志 忌批扳快把快 扼 扶快抉忌抒抉忱我技抑技
                    {
                        break;
                    }
                }
            ...
            //妤抉抖批折忘快技 忘忱把快扼 扳批扶抗扯我我 LoadLibraryA
